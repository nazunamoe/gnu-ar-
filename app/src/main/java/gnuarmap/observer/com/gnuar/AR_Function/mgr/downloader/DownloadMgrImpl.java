 ...
 */
package gnuarmap.observer.com.gnuar.AR_Function.mgr.downloader;
...
import gnuarmap.observer.com.gnuar.AR_Function.data.convert.DataConvertor;
...
class DownloadMgrImpl implements Runnable, DownloadManager {
	...
	public void run() {
		...
		gnuarmap.observer.com.gnuar.AR_Function.mgr.downloader.DownloadResult result;
		stop = false;
		while (!stop) {
			...
			while (!stop) {
				try {
					...
					result = new gnuarmap.observer.com.gnuar.AR_Function.mgr.downloader.DownloadResult();
	...
	private gnuarmap.observer.com.gnuar.AR_Function.mgr.downloader.DownloadResult processRequest(ManagedDownloadRequest mRequest) {
		gnuarmap.observer.com.gnuar.AR_Function.mgr.downloader.DownloadRequest request = mRequest.getOriginalRequest();
		final gnuarmap.observer.com.gnuar.AR_Function.mgr.downloader.DownloadResult result = new gnuarmap.observer.com.gnuar.AR_Function.mgr.downloader.DownloadResult();
		try {
			if (request == null) {
			...
			String pageContent = gnuarmap.observer.com.gnuar.AR_Function.mgr.HttpTools.getPageContent(request,
	 ...
	 * .DownloadRequest)
	 */
	public String submitJob(gnuarmap.observer.com.gnuar.AR_Function.mgr.downloader.DownloadRequest job) {
		String jobId = null;
	...
	public DownloadResult getReqResult(String jobId) {
		gnuarmap.observer.com.gnuar.AR_Function.mgr.downloader.DownloadResult result = doneList.get(jobId);
	...
	public synchronized DownloadResult getNextResult() {
		gnuarmap.observer.com.gnuar.AR_Function.mgr.downloader.DownloadResult result = null;
		if (!doneList.isEmpty()) {
