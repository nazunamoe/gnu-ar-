 ...
 */
package gnuarmap.observer.com.gnuar.AR_Function.data.convert;
...
import gnuarmap.observer.com.gnuar.AR_Function.data.DataSource;
...
public class DataConvertor {
	...
	private List<gnuarmap.observer.com.gnuar.AR_Function.data.convert.DataProcessor> dataProcessors = new ArrayList<DataProcessor>();
	...
	public void addDataProcessor(gnuarmap.observer.com.gnuar.AR_Function.data.convert.DataProcessor dataProcessor){
		dataProcessors.add(dataProcessor);
	}
	
	public void removeDataProcessor(gnuarmap.observer.com.gnuar.AR_Function.data.convert.DataProcessor dataProcessor){
		dataProcessors.remove(dataProcessor);
	}
	
	public List<Marker> load(String url, String rawResult, DataSource ds){
		gnuarmap.observer.com.gnuar.AR_Function.data.convert.DataProcessor dataProcessor = searchForMatchingDataProcessors(url, rawResult, ds.getType());
		if(dataProcessor == null){
			dataProcessor = new gnuarmap.observer.com.gnuar.AR_Function.data.convert.MixareDataProcessor(); //using this as default if nothing is found.
		}
		try {
	...
	private gnuarmap.observer.com.gnuar.AR_Function.data.convert.DataProcessor searchForMatchingDataProcessors(String url, String rawResult, DataSource.TYPE type){
		for(gnuarmap.observer.com.gnuar.AR_Function.data.convert.DataProcessor dp : dataProcessors){
	...
	private void addDefaultDataProcessors(){
		dataProcessors.add(new gnuarmap.observer.com.gnuar.AR_Function.data.convert.WikiDataProcessor());
		dataProcessors.add(new gnuarmap.observer.com.gnuar.AR_Function.data.convert.TwitterDataProcessor());
		dataProcessors.add(new gnuarmap.observer.com.gnuar.AR_Function.data.convert.OsmDataProcessor());
	}
