...
public class DataSource extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
			if (extras.containsKey("DataSourceId")) {
				String fields[] = gnuarmap.observer.com.gnuar.AR_Function.data.DataSourceStorage.getInstance().getFields(
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
			...
			int index = gnuarmap.observer.com.gnuar.AR_Function.data.DataSourceStorage.getInstance().getSize();
			Bundle extras = getIntent().getExtras();
			if (extras != null) {
				if (extras.containsKey("DataSourceId")) {
			...
			gnuarmap.observer.com.gnuar.AR_Function.data.DataSourceStorage.getInstance().add("DataSource" + index,
					newDS.serialize());
		}
