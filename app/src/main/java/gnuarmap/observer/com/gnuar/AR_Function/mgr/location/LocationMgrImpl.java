 ...
 */
package gnuarmap.observer.com.gnuar.AR_Function.mgr.location;
...
import gnuarmap.observer.com.gnuar.AR_Function.mgr.downloader.DownloadManager;
...
class LocationMgrImpl implements LocationFinder {
	...
	private final gnuarmap.observer.com.gnuar.AR_Function.mgr.location.LocationObserver lob;
	private List<gnuarmap.observer.com.AR_Function.mgr.location.LocationResolver> locationResolvers;
	...
	public LocationMgrImpl(MixContext mixContext) {
		...
		this.locationResolvers = new ArrayList<org.mixare.mgr.location.LocationResolver>();
	}
	...
	private void requestBestLocationUpdates() {
		...
		for (String p : lm.getAllProviders()) {
			if(lm.isProviderEnabled(p)){
				org.mixare.mgr.location.LocationResolver lr = new org.mixare.mgr.location.LocationResolver(lm, p, this);
	...
	class LocationTimerTask extends TimerTask {
		...
		public void run() {
			...
			for(org.mixare.mgr.location.LocationResolver locationResolver: locationResolvers){
